...
class TaskSystemParallelThreadPoolSleeping: public ITaskSystem {
    ...
    private:
        ...
        // Tracking for bulk task launches
        struct BulkTaskInfo {
            IRunnable* runnable;
            int total_tasks;
            int completed_tasks;
            bool is_ready;
            std::set<int> tasks;  // Set of task indices
            std::set<TaskID> pending_deps;  // Dependencies not yet satisfied
        };
        std::unordered_map<TaskID, BulkTaskInfo> bulk_tasks;
